...
ops.fbinary             = fullfile('DATA_CAR.dat'); % will be created for 'openEphys'		
...
ops.whiteningRange      = 2; % how many channels to whiten together (Inf for whole probe whitening, should be fine if Nchan<=32)		
...
ops.ntbuff              = 4;    % samples of symmetrical buffer for whitening and spike detection		
...
ops.momentum         = 1./[20 10000];  % start with high momentum and anneal (1./[20 1000])		
